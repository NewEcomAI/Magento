        ...
        $(document).ready(function() {
            ...
            function searchResult(response) {
                ...
                if (searchText !== currentSearchQuery) {
                    ...
                    appendShowDecideResponse(searchResponseData);
                }
            }
            function appendShowDecideResponse(response) {
                let responseData = response.response;
                let additionalInfo = `<div class="container"><p class="paragraph">${responseData}</p></div>`;
                let searchResult = {
                ...
                $(".newcom-query-response").last().html(additionalInfo);
            ...
            function showDecideResponse(response) {
                ...
                let result = searchResultsArray[searchResultsArray.length - 1];
