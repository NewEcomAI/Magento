define([
    ...
    "use strict";
    return function decideTemplateNewcom() {
        $(document).ready(function() {
            // Array to store search results
            var searchResultsArray = [];

            $("#NewEcomAi-search").click(function() {
                var searchText = $("#NewEcomAi-question").val().trim();
                var searchResultsDiv = $("#NewEcomAi-search-result");

                if (searchText === "") {
                    alert("Write your question");
                } else {
                    var additionalInfo = `<div class="container"><p class="paragraph">Here are some products that might interest you:</p>
                    ...
                    $.each(searchResultsArray, function(index, result) {
                        ...
                        // Check if feedback has been given for this result
                        if (result.feedbackGiven) {
                            // If feedback has been given, show the "Thanks for your feedback" message
